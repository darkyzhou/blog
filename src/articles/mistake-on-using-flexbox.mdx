...
export const title = '记一次对 CSS FlexBox 的误用'
export const date = '2020-09-04T20:12:10.123Z'
...
<BlogImage filePath="mistake-on-using-flexbox/mistake-on-using-flexbox-1" />
