...
export const title = '探究 DDD 在前端开发中的应用（三）：探究 DDD 在前端开发中的应用'
export const date = '2020-07-31T23:14:54.123Z'
...
<BlogImage filePath="frontend-with-ddd/frontend-with-ddd-3-16" caption='客户端 App 和管理端 App 分别利用了一个共享的 Library 和一个独享的 Library' />
...
<BlogImage filePath="frontend-with-ddd/frontend-with-ddd-3-17" caption='图片来自 Manfred 的《Enterprise Angular》' />
...
<BlogImage filePath="frontend-with-ddd/frontend-with-ddd-3-18" caption='图片来自 Manfred 的《Enterprise Angular》' />
...
<BlogImage filePath="frontend-with-ddd/frontend-with-ddd-3-19" caption='代码来自 Manfred 的《Enterprise Angular》' />
...
<BlogImage filePath="frontend-with-ddd/frontend-with-ddd-3-20" caption='代码来自 Manfred 的《Enterprise Angular》' />
...
<BlogImage filePath="frontend-with-ddd/frontend-with-ddd-3-21" />
...
<BlogImage filePath="frontend-with-ddd/frontend-with-ddd-3-22" caption='反馈系统的通知页面' />
...
<BlogImage filePath="frontend-with-ddd/frontend-with-ddd-3-23" caption='右边是这些 Library 形成的逻辑层级，箭头表示依赖关系，可以看到在 notification 限界上下文中我们得到了一个清晰的 Library 的依赖关系，这将有利于我们区分代码职责，以及后续的维护' />

下图是 domain library 中的 notification.entity.ts 和 update-notification-status.facade.ts。

<BlogImage filePath="frontend-with-ddd/frontend-with-ddd-3-24" caption='我在 Notification 实体类中还引入了 class-transformer 包的修饰器，它可以自动将服务端传来的 string 类型的 time 转换为 Date 类' />
...
<BlogImage filePath="frontend-with-ddd/frontend-with-ddd-3-25" />
