...
export const title = '如何在 JavaScript 中优雅地创建并初始化数组'
export const date = '2023-05-03T14:00:00.425Z'
...
<BlogImage filePath="js-array-creation/js-array-creation-1" />
...
<BlogImage filePath="js-array-creation/js-array-creation-2" />
