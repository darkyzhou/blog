...
export const title = '浅谈 JavaScript 异步编程（三）：JS 异步编程的发展'
export const date = '2020-04-26T11:12:25.123Z'
...
<BlogImage filePath="async-js/async-js-3-1" alt="Callback Hell" />
...
<BlogImage filePath="async-js/async-js-3-2" />
...
<BlogImage filePath="async-js/async-js-3-3" />
...
<BlogImage filePath="async-js/async-js-3-4" />
...
<BlogImage filePath="async-js/async-js-3-5" />
...
<BlogImage filePath="async-js/async-js-3-6" alt="浏览器中新推出的用以取代老旧的 XMLHttpRequest API 的 Fetch API" />

<BlogImage filePath="async-js/async-js-3-7" alt="ES2020 标准中引入的 Dynamic Import" />
...
<BlogImage filePath="async-js/async-js-3-8" alt="在“先”与“后”之间始终存在着阻隔思维流的代码" />
...
<BlogImage filePath="async-js/async-js-3-9" />
...
<BlogImage filePath="async-js/async-js-3-10" />
...
<BlogImage filePath="async-js/async-js-3-11" />
...
<BlogImage filePath="async-js/async-js-3-12" alt="一个 Async Iteration 的用例，需要实现 Async Iterator 或 Async Generator" />
