...
export const title = "如何打造可被摇树优化的库"
export const date = "2021-06-24T20:16:38.104Z"
...
<BlogImage filePath="how-to-make-a-tree-shakable-library/tree-shaking-0" caption='如何打造可被摇树优化的库' />
...
<BlogImage filePath="how-to-make-a-tree-shakable-library/tree-shaking-1" caption='一个可摇树优化的库的例子' />
...
<BlogImage filePath="how-to-make-a-tree-shakable-library/tree-shaking-2" caption='一个摇树优化后的库对应的一张简单的模块图' />
...
<BlogImage filePath="how-to-make-a-tree-shakable-library/tree-shaking-3" caption='使用 ESM 格式的库的导出模块图' />
...
<BlogImage filePath="how-to-make-a-tree-shakable-library/tree-shaking-4" caption='副作用优化下的模块图' />
...
<BlogImage filePath="how-to-make-a-tree-shakable-library/tree-shaking-5" caption='在使用 CJS 格式的依赖时，保留模块结构能够改善摇树优化效果' />
...
<BlogImage filePath="how-to-make-a-tree-shakable-library/tree-shaking-6" caption='代码分割导致摇树优化出现的问题' />
...
<BlogImage filePath="how-to-make-a-tree-shakable-library/tree-shaking-7" caption='保留模块树可以让 Webpack 独立地对分割的 chunk 进行摇树优化' />
...
<BlogImage filePath="how-to-make-a-tree-shakable-library/tree-shaking-8" caption='Webpack的 innerGraph 优化示例' />
