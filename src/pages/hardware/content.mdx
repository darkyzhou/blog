...
- RAM: KLEVV BOLT-X DDR4-3200 16 GiB x 2
- GPU: Inno3D RTX 5060 Ti TWIN X2 16 GiB GDDR7
- SSD1: HP EX950 1 GiB
- SSD2: ADATA SP580 240 GiB
- Motherboard: ASUS PRIME A520M-K
- OS: NixOS 25.05 (Warbler) x86_64
- Kernel: Linux 6.14.1-zen1

这是我最近组的用于深度学习的主机，主要用于训练一些音频模型，以及运行一些本地模型应用，例如 ComfyUI。

<BlogImage filePath="hardware/seele1" caption="映众的这张卡的设计朴素且规整" />
<BlogImage filePath="hardware/seele2" caption="目前，这台主机位于我的电脑桌右边" />
