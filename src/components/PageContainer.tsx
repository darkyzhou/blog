...
export function PageContainer({ children, title }: PageContainerProps) {
  ...
  return (
    ...
    >
      ...
      <div className="z-10 row-start-3 col-span-8 h-[12.5dvh] bg-carbongray-800 pointer-events-auto sticky top-[12.5dvh] -mt-[12.5dvh] md:-mr-12 lg:-mr-16 xl:-mr-32 border-b border-carbongray-600/40">
        <div className="px-4 md:px-12 lg:px-16 pb-4 h-full flex justify-start items-end text-2xl lg:text-3xl text-carbongray-50">
          {title}
        </div>
      </div>
      ...
      <div className="col-span-full md:hidden text-carbongray-400 text-sm text-center py-8">
        <Footer showStats />
      </div>
    </main>
  )
