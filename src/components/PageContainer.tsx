...
export function PageContainer({ children, title, pageTitle }: PageContainerProps) {
  ...
  return (
    ...
    >
      ...
      <header className="z-10 row-start-3 col-span-8 h-[12.5vh] bg-carbongray-800 pointer-events-auto md:-mr-12 lg:-mr-16 xl:-mr-32 border-b border-carbongray-600/40">
      ...
      <div className="row-start-4 col-span-8 grid grid-cols-subgrid bg-carbongray-900 pointer-events-auto md:-mr-12 lg:-mr-16 xl:-mr-32">
